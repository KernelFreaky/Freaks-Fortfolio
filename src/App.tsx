    ...
    <>
      ...
      <div id="home">
        ...
        <section className="flex justify-center mt-10 sm:mt-16 md:mt-20 flex-col items-center px-4 sm:px-6">
          ...
          <a href='FREQUEMARF_PACULBA_JR_Resume.pdf' target="_blank" className="border border-yellow-400 p-2 sm:p-3 md:p-4 text-white rounded-md bg-gray-800 hover:bg-black cursor-pointer text-sm sm:text-base transition-all duration-200 hover:scale-105 z-100">
            View CV
          </a>
